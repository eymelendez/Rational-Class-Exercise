...
// The GDC (Greatest Common Divider) is used in combination with the Simplify Function to determine the number used to make 
...
// Simplify takes a number that can be made smaller by comparing both numbers. For example the fraction 4/16 can be simplified to 1/4.
